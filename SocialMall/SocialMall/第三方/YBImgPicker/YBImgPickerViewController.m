...
#define rightItemTitle [NSString stringWithFormat:@"确定"]
...
- (void)getCollectionData:(NSInteger)tag {
    ...
    [colletionData addObject:[UIImage imageNamed:@"camera_icon"]];
    if (tableData.count) {
...
- (void)hide{
    //发送通知
    [[NSNotificationCenter defaultCenter] postNotificationName:@"didSelectZQNotification" object:@""];
