...
-(void)loadData{
   ...
   [self.requestManager requestWebWithParaWithURL:@"User/getAllRecord" Parameter:nil IsLogin:YES Finish:^(NSDictionary *resultDic) {
       NSLog(@"成功");
       NSLog(@"返回==%@",resultDic);
       NSArray *messageList = resultDic[@"data"][@"allRecord"];
