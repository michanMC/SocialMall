...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
       ...
       // [self.contentView addSubview:_bgView];
        ...
        _title2Lbl = [[UILabel alloc]initWithFrame:CGRectMake(0, 10, 22, 25)];
        _title2Lbl.textColor = AppCOLOR;
        _title2Lbl.font = [UIFont systemFontOfSize:13];
        [self.contentView addSubview:_title2Lbl];
        _title2Lbl.textAlignment = NSTextAlignmentCenter;
...
-(void)setTitle2Str:(NSString *)title2Str
{
    ...
    CGFloat w = [MCIucencyView heightforString:title2Str andHeight:20 fontSize:13]+ 15;
  ...
  // _bgView.frame = CGRectMake(Main_Screen_Width - 10 - w - 10 - 10, 10, w + 10 + 10, 20);
   ...
   // _imgView.frame = CGRectMake(Main_Screen_Width  - w - 15 - 15, _imgView.frame.origin.y, 15, 15);
    ...
    _title2Lbl.frame = CGRectMake(Main_Screen_Width - 10 - w - 5, 7.5, w, 25);
    _title2Lbl.layer.borderWidth = 1;
    _title2Lbl.layer.borderColor = UIColorFromRGB(0x29477d).CGColor;
    ViewRadius(_title2Lbl, 25/2);
