...
+ (void)initialize
{
    ...
    selDict[NSForegroundColorAttributeName] = AppCOLOR;
...
- (void)viewDidLoad {
    ...
    /*添加子控制器 */
    /** 精华 */
    [self setUpChildControllerWith:[[GuanzhuViewController alloc]init] norImage:[UIImage imageNamed:@"tabBar_essence_icon"] selImage:[UIImage imageNamed:@"tabBar_essence_click_icon"] title:@"精华"];
    
    /** 新帖 */
    [self setUpChildControllerWith:[[FaxianViewController alloc] init] norImage:[UIImage imageNamed:@"tabBar_new_icon"] selImage:[UIImage imageNamed:@"tabBar_new_click_icon"]title:@"新帖"];
    
    /** 关注 */
    [self setUpChildControllerWith:[[FabuViewController alloc] init] norImage:[UIImage imageNamed:@"tabBar_friendTrends_icon"] selImage:[UIImage imageNamed:@"tabBar_friendTrends_click_icon"] title:@"关注"];
    
    /** 我的 */
    [self setUpChildControllerWith:[[MeViewController alloc] init] norImage:[UIImage imageNamed:@"tabBar_me_icon"] selImage:[UIImage imageNamed:@"tabBar_me_click_icon"] title:@"我的"];
...
{
    MCNavViewController *nav = [[MCNavViewController alloc] initWithRootViewController:childVc];
